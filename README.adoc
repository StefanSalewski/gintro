...
NOTE: This is version 0.8.7 of the gintro Nim GTK bindings.
...
Also for this version 0.8.7 we do support webkit2 for GTK4, and we have
fixed the  newGFileTmp() issue, see https://github.com/StefanSalewski/gintro/issues/112.
