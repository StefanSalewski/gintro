...
NOTE: This is version 0.9.0 of the gintro library. It is mostly a plain fix for issue https://github.com/StefanSalewski/gintro/issues/133.
...
https://github.com/StefanSalewski/gintro/issues/137. But we will leave that for next version 0.9.1.
