...
NOTE: This is version 0.8.8 of the gintro Nim GTK bindings.
Due to unsufficient testing a tiny bug made it into this release causing it to compile for
GTK4 only with --gc:arc.   *nimble install gintro@#head* or the next release should fix that.
