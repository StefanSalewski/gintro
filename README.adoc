...
NOTE: We are currently preparing version 0.9.2 of the gintro Nim bindings which fixes the latest gstreamer issue -- you may install it
with nimble install gintro@#head.

NOTE: This version 0.9.1 is mostly a plain fix for issue https://github.com/StefanSalewski/gintro/issues/133.
