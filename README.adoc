...
NOTE: We are currently preparing version 0.8.6 of the gintro Nim GTK bindings.
The package contains now all the standard gst modules, and due to a recent
...
NOTE: This is version 0.8.5 of the gintro Nim GTK bindings.
Due to a serious request we have added webkitgtk support.
