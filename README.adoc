...
NOTE: We are currently preparing gintro v0.8.4.
You may install it with command [black yellow-background]#nimble install gintro@#head#.
We now try to support optional var out parameters, see  https://github.com/StefanSalewski/gintro/issues/102
and tried to fix https://github.com/StefanSalewski/gintro/issues/99. And GtkGestures should work now, thanks
to some hints of Mr. Bassi, see https://discourse.gnome.org/t/gtk4-gtkgesture-and-ref-count/4809.
